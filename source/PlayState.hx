	...
	override public function create()
	{
		...
		switch(SONG.song.toLowerCase())
		{
			case 'maybe-i-was-boring', 'in-love-with-egirl', 'internet-ruined':
			{
				...
				var evilSnow:FlxSprite = new FlxSprite(-400, 700).loadGraphic(Paths.image("London/sidewalk"));
			...
			case 'rifting':
			{
				...
				people.active = true;
				people.setGraphicSize(Std.int(people.width * 0.8));
				people.updateHitbox(); 
				add(people);
		...
		healthBar.createFilledBar(0xFF008080, 0xFF87CEEB);
		// healthBar
		add(healthBar);
